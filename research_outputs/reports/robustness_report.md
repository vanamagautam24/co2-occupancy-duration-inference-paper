...
Generated: 2026-02-15 15:19

## 1. Executive Summary

- **24 subjects** mapped to **12 sensors**
- **774 block-level estimates** (535 present, 239 absent)
- Mean estimated occupied minutes (label=1): **38.4 min** (median: 0.0 min)
...
**Result**: Mean unclamped estimate = 11.23 minutes, 80.3% under 5 minutes, P95 = 70.19 minutes
...
**Result**: Mean MAE between own and cross-sensor estimates = 43.46 minutes (relative MAE = 1.45), mean Spearman rank correlation = 0.275
...
- label1_mean_uncertainty_width: 60.5
- label1_median_uncertainty_width: 42.8
- pct_high_confidence: 45.2
- pct_medium_confidence: 10.3
- pct_low_confidence: 44.5
...
| shared | 138 | 34.1 | 46.4 |
| single | 397 | 39.9 | 65.5 |
