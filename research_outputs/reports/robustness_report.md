...
- Mean estimated occupied minutes (label=1): **32.0 min** (median: 0.0 min)
- This represents **13%** of each 4-hour block on average
...
**Result**: Mean unclamped estimate = 10.77 minutes, 79.9% under 5 minutes, P95 = 78.68 minutes
...
- label1_mean_uncertainty_width: 59.5
- label1_median_uncertainty_width: 36.9
- pct_high_confidence: 46.2
- pct_medium_confidence: 9.0
- pct_low_confidence: 44.9
...
| shared | 138 | 28.9 | 45.4 |
| single | 397 | 33.1 | 64.4 |
